      ...
      <form method="POST" action="{{ route('save-barang') }}">
        @csrf
            <div class="form-group row mb-3">
              ...
              <div class="col-sm-2">
                  <input type="text" class="form-control form-control-sm" id="" name="id_barang" readonly value="{{ $newlyCreatedId }}">
              </div>
            </div>      
            <div class="form-group row mb-3">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control form-control-sm" id="nama" name="harga">
              </div>
            </div>
            <div class="form-group row mb-3">
