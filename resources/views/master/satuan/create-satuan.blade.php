      ...
      <form method="POST" action="{{ route('save-satuan') }}">
        @csrf
            <div class="form-group row mb-3">
              ...
              <div class="col-sm-2">
                  <input type="text" class="form-control form-control-sm" id="" name="id_satuan" readonly value="{{ $newlyCreatedId }}">
              </div>
            </div>      
            <div class="form-group row mb-3">
              <label for="nama_satuan" class="col-sm-2 col-form-label">Nama Satuan</label>
              <div class="col-sm-10">
                <input type="text" class="form-control form-control-sm" id="nama_satuan" name="nama_satuan">
              </div>
            </div>
            <div class="form-group row mb-3">
